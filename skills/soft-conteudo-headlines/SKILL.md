...
- `references/templates.md`: **O CÂNONE POR GATILHO completo** (as 86 fórmulas T nas 6 famílias, com a gramática de slots no topo, os exemplos multi-nicho, as variações fundidas e as notas de refinamento) + a numeração C1-C6 dos ângulos de ataque de frase + os **ângulos de ABORDAGEM** (a camada de tema/grande-ideia que roda por cima, com causa-raiz na frente em saúde). **Central nos Passos 2-3.**
