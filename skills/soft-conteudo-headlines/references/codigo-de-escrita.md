...
## 1. A lente: percepção, não marketing

O núcleo não é marketing. É **engenharia de percepção.**

Você não descreve o especialista. Reorganiza como o cliente enxerga o próprio problema, e quem resolve.

Marca é percepção, não descrição. Autoridade não é diploma nem seguidor: é percepção organizada de competência. O cérebro escolhe quem parece claro, certo e diferente, e descarta quem parece confuso, inseguro ou igual.

Tudo gira em torno de quatro coisas: como o público interpreta valor, como a identidade puxa a compra, como a linguagem muda a autoridade percebida, como a clareza vira desejo.

A pergunta que abre toda peça: **que percepção eu estou reorganizando?**
...
6. **Repita a tese.** As mesmas teses, contrastes e inimigos, sempre. Marca é repetição. Não tenha medo de voltar.
7. **Ancore.** Toda tese fecha em chão: um número, o Otávio, um mecanismo. Tese sem chão é a doença que o método cura. "O mercado paga o mais percebido" é bonito; sozinho, é vazio. Com o especialista de dez anos perdendo pro curso de três meses, vira lâmina.
8. **Rótulo não é explicação.** As palavras do método (posição, percepção, autoridade, **invisibilidade**) são etiqueta interna. Sozinhas, pro leitor, não dizem nada: "o problema é posição" é vazio, ele não sente "posição"; **ninguém se reconhece em "você é invisível".** Na peça, o rótulo vira o sintoma concreto na pele do cara: posição → "ninguém lembra do teu nome primeiro"; **invisibilidade → o teto que ele bate ("sou bom, podia ser muito maior, e não sai do lugar"), comparado por preço, vendo gente pior na frente.** Descreva o que o conceito É na vida dele, nunca o nome dele.

---

## O teste de cada frase (passa nas 3, ou reescreve)
...
2. **Dá pra provar ou desmentir?** Frase que não é verdadeira-ou-falsa é enchimento. "Somos referência" não se prova; "atendi 800 pacientes em dez anos" *(número ilustrativo, ex. nutricionista)* se prova. Não diga o adjetivo, aponte o fato.
3. **Só você poderia dizer isso?** Se o concorrente assina a mesma frase, ela não diferencia. "Ajudo você a crescer" qualquer um assina; "monto com você o mesmo consultório que lotei sem depender de indicação" *(exemplo ilustrativo, ex. dentista)* só você.
...
## 3. Os mecanismos (como a percepção se constrói)

Os movimentos que toda peça forte usa pra reorganizar a cabeça do leitor:

- **Polaridade.** Todo texto tem dois lados: invisível × procurado, volume × percepção, creator × especialista. Tensão gera atenção. O contraste sai de um de três: abordagem (jeito A vs jeito B), crença (o que pregam vs o que você defende), ou inimigo (você vs a cultura). Nunca escreva um anúncio que o concorrente também assinaria.
...
## 4. A estrutura-mãe (como a PEÇA se move)

**Diagnóstico → Nomeação → Polaridade → Nova interpretação → Consequência → Movimento**

Copy não convence. Reorganiza percepção. O leitor chega sozinho na conclusão e a venda vira consequência, não empurrão. É o "filtra E convence, revela não empurra".

---

## 5. A função de cada peça (o sistema de conteúdo)
...
**Anti-voz de exemplo** (cresce a cada correção do especialista): o autor do método NÃO usa **"travar / travado / trava"** (era "travar a posição"). Prefere ocupar, cravar, fincar, deixar de pé, feito. Pra cliente bloqueado: empacado, emperrado. A lista de anti-voz é viva e cada especialista mantém a sua.
...
Identificação profunda gera autoridade instantânea. Quem nomeia o problema melhor que o próprio mercado, vira referência.

As forças reais por trás da compra não são "marketing". São: invisibilidade, reconhecimento, diferenciação, comparação, identidade, status, simplificação, percepção de valor. O marketing é só a manifestação disso. Escreva pra essas forças.
...
Antes de qualquer peça sair, duas perguntas:
**"que percepção estou reorganizando?"** e **"onde está o chão?"** (número, Otávio, mecanismo).

Sem as duas respostas, não sai.
