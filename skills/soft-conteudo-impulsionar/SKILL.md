...
description: Decide o IMPULSIONAR/tráfego pago do método Soft (o que turbinar, quanta verba, quantos dias, qual público) e diagnostica campanha que não retorna. Também AVALIA/PONTUA uma peça ANTES de publicar (Modo Avaliar), num duplo eixo que se soma, empírico (probabilidade de performar contra o histórico REAL do próprio perfil) + doutrinário (qualidade pelo gate Soft), veredito e até 3 correções com dado real, sem inventar benchmark. Parte de peças que JÁ provaram engajamento, aplica a régua de custo por seguidor e o 50/30/20. Use quando o pedido for "impulsionar", "turbinar", "tráfego pago", "anúncio", "campanha", "qual verba", "meu anúncio não retorna", "ROAS", "custo por seguidor", "tráfego pro webinar", "dá uma nota nesse post", "vai bombar", "avalia antes de publicar", "combina com meu perfil". NÃO use pra ARTE (soft-designer), pra ESCREVER a peça (soft-conteudo-carrossel/-reels/-stories/-headlines), pra lançamento pago (soft-launch), nem pro posicionamento (soft-plano-posicionamento).
---
