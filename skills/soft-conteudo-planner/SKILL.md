...
description: PLANEJAMENTO de conteúdo do método Soft em 2 modos, decide QUAIS temas atacar. MODO MATRIZ (ideação em lote, o mapa do mês) cruza os pilares do dono por 8 formatos e devolve 30+ pautas ESPECÍFICAS numa matriz-calendário, cada célula uma manchete ancorada no verbatim/tese que aponta pro método. MODO RADAR (tendências do nicho, pauta viva datada) varre a web AGORA (WebSearch quando dá, senão conduz com o que o dono cola), pega o que está quente nos últimos dias e devolve temas com o ângulo Soft pra postar. Cada célula/linha vira input pra soft-conteudo-headlines. Use pra "ideias de post", "matriz de conteúdo", "sobre o que eu posto", "pauta do mês", "banco de pautas", "o que tá em alta no nicho", "tendências da semana", "o que tá bombando". NÃO use pra a HEADLINE de pauta escolhida (soft-conteudo-headlines), o CORPO da peça (soft-conteudo-carrossel/-reels/-stories), a fundação de mercado/dor/concorrente (Super Pesquisa em soft-plano-posicionamento, de onde vêm os pilares), arte (soft-designer), funil/venda.
---
