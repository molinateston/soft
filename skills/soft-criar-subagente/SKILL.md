...
description: Cria um subagente novo do zero (Claude Code ou OpenClaw), com personalidade, system prompt, tools restritas e nicho especifico. Acionar quando o dono disser "cria um subagente pra X", "preciso de um agente especialista em Y", "monta um subagente novo de Z", "quero um SDR de estetica", "cria um copywriter de mercado financeiro", "monta um analista de dados", "adiciona um agente novo no time", "expande a equipe com mais um agente", "preciso de um especialista em determinado nicho", ou qualquer pedido pra adicionar um novo membro o time de bracos do agente (alem dos bracos leon-* que ja existem).
