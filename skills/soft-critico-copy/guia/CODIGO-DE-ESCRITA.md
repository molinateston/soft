...
8. **Rótulo não é explicação.** As palavras do método (posição, percepção, autoridade) são etiqueta interna. Sozinhas, pro leitor, não dizem nada: "o problema é posição" é vazio, ele não sente "posição". Na peça, o rótulo vira o sintoma concreto na pele do cara: posição → "ninguém lembra do teu nome primeiro". Descreva o que o conceito É na vida dele, nunca o nome dele.
...
2. **Dá pra provar ou desmentir?** Frase que não é verdadeira-ou-falsa é enchimento. "Somos referência" não se prova; "R$3 milhões em dez anos" se prova. Não diga o adjetivo, aponte o fato.
...
**Anti-voz do dono** (cresce a cada correção dele): ele NÃO usa **"travar / travado / trava"** (era "travar a posição"). Prefere ocupar, cravar, fincar, deixar de pé, feito. Pra cliente bloqueado: empacado, emperrado. Lista viva na memória do dono.
