...
```json
{
  ...
  "personagens": {
    ...
    "mascote": "MASCOT, a <animal/cor/estilo>, <textura, olhos, roupa, proporcao, bem detalhado>",
...
- Inclua sempre os "NUNCA" de cada personagem (ex.: "NEVER an insect", "NEVER a smooth ball head") pra prender o gerador de imagem ao personagem certo.
