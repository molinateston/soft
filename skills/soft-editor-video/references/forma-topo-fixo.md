# FORMA "TOPO-FIXO" - talking-head em cima, apoio embaixo

É a segunda forma desta skill, ao lado do b-roll IA de rodapé. Use esta forma
quando o vídeo cru é o dono falando à câmera e o apoio são SLIDES de texto +
TELAS reais (print ou gravação de produto), não cenas geradas por IA. Motor:
React/Remotion, não os scripts Python de b-roll.
...
## As 4 correções cravadas da forma (reproduza sempre)

- A · LEGENDA branca fina rente à divisão (não caixa grossa, não centro da tela).
- B · FALA TRATADA: corta respiração, pausa e silêncio, e acelera 1.2x; o vídeo
  começa JÁ na fala. Num cru de referência isso levou 518s a 384s (6min24s) sem
  perder sentido. Enxuga o morto, não o conteúdo.
- C · ENQUADRAMENTO do rosto INTOCADO: o crop e o zoom do `clean_top.mp4` que já
  ficaram bons não se mexem. Calibre uma vez por cru novo (a referência que
  funcionou num cru vertical de celular: top -700, left -135, largura 1350,
  altura 2400) e não mexa depois de aprovado.
- D · TROCA slide, TELA, slide: no ponto em que a fala cita algo que dá pra
  ...
  slide por volta de 1,4s e então a TELA real assume a faixa; ao fim volta pro
  slide seguinte. Regra prática: toda vez que a fala nomeia uma tela, essa tela
  aparece.
...
6. Versão leve pro mensageiro (a maioria corta em 50MB; o master vai pro
...
a prova é o mosaico olhado, não a nota do script. Se o ambiente não tiver
capacidade de olhar imagem, entregue o mosaico ao dono e diga que a conferência
visual ficou com ele: nunca afirme que olhou.

## O molde visual da família

Depois que um vídeo desta forma passa pela aprovação do dono, ele vira o molde
da família: os demais vídeos copiam o mesmo tratamento, sem redecidir nada.
O molde é este conjunto de decisões:
...
- Não colocar nome de marca nem de oferta na faixa de cima; o topo é só o rosto.
...
- Preservar o vídeo-molde sem regenerar nem alterar depois de aprovado.
...
que o dono citou e conferir essa mesma classe no vídeo inteiro. Elemento
aprovado não volta para edição.
