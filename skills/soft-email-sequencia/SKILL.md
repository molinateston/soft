...
`references/EXEMPLO-FIM-A-FIM.md` (o caso fictício de ponta a ponta) · `references/tipos-e-cadencias.md` · `references/anatomia-do-email.md` · `references/logica-de-fluxo.md` · `references/gate-linha-a-linha.md` · `scripts/lint_copy.py` (o anti-IA em código, rode no shell quando o ambiente permitir) · `shared-references/filtro-anti-ia/` (a régua anti-IA escrita, pro motor que não roda o lint).
