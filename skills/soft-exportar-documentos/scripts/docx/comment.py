...
import _bootstrap  # noqa: F401  (poe scripts/ e scripts/office/ no caminho)
import os as _os

# Autor do comentario: marca-neutro por padrao, sobrescrito por variavel de ambiente.
_DEFAULT_AUTOR = _os.environ.get("DOC_AUTOR", "Revisor")
_DEFAULT_INICIAIS = _os.environ.get("DOC_INICIAIS", _DEFAULT_AUTOR[:1].upper() or "R")
...
def add_comment(
    ...
    author: str = _DEFAULT_AUTOR,
    initials: str = _DEFAULT_INICIAIS,
...
def main() -> None:
    ...
    p.add_argument("--author", default=_DEFAULT_AUTOR,
                   help="Nome do autor do comentario (default: variavel de ambiente DOC_AUTOR, ou Revisor)")
