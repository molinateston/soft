...
→ Conserto positivo no `teste-construtivo.md` (pergunta 2): no lugar dos 2 adjetivos, 1 fato que dá pra apontar. "Sistema simples e poderoso" vira "sistema que fecha 3 clientes por semana".
...
→ Conserto positivo no `teste-construtivo.md` (pergunta 1, o teste do zoom): reescreve o abstrato até bater num objeto ou numa cena. "Clareza" vira "saber o que postar amanhã sem empacar na frente da tela".
...
✅ "Em julho a entrada do mês ainda depende de você aparecer amanhã no feed."
✅ "No dia 1 a entrada ainda depende de mais um post."
...
Rodar o linter NÃO substitui ler em voz alta. Ele garante que os tells HARD nunca passem por esquecimento; o resto é leitura + voz.

**Antes de reprovar qualquer coisa:** roda a checagem de falso positivo. Prosa autoral legítima bate em vários desses padrões sem nenhuma IA envolvida. Reprova por AGLOMERADO de tells (ou por HARD isolado), nunca por um WARN isolado. A régua do que NÃO corrigir está em `falsos-positivos.md`.
