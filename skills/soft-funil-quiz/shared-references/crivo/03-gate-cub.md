...
- **FATO NARRADO sobre o dono ou o cliente é da fonte, nunca inventado.** História, jornada, cena de origem, confissão, "o dia em que entendi", "eu achava X até descobrir Y", biografia: tudo isso é FATO, mesmo sem aspas nem número. Só entra se vier do insumo ou do perfil (`00-perfil-do-usuario.md`, acervo de fala real). Uma cena plausível na boca do dono ("eu achava que era falta de disciplina delas, até o dia que entendi...") sem NENHUM insumo que a sustente é biografia fabricada, e é o mesmo crime da aspa fabricada, só que em prosa. Sem lastro, vira `[A CONFIRMAR: história de X]` no bastidor e a peça se escreve só com o que é real. História plausível inventada, FALHA bloqueante.
- **PARÁFRASE não estica: preserva o que a fala diz, nunca acrescenta.** Parafrasear o verbatim é permitido (fora das aspas, ver regra acima), mas a paráfrase não pode ADICIONAR fato ausente da fala original: número, prazo, frequência, detalhe. O dono disse "começo e paro"; a peça escreveu "para antes da terceira semana" e inventou a "terceira semana" que ninguém falou. A especificidade nova é invenção, ainda que a moldura pareça fiel. A paráfrase carrega o sentido da fala e para onde a fala parou. Adição de fato na paráfrase, FALHA bloqueante.
- **PLACEHOLDER mora no bastidor, jamais no corpo publicável.** `[A CONFIRMAR: ...]`, `[CASE: ...]`, `Link: [A CONFIRMAR]` e qualquer marca de pendência vivem no relato, no dossiê, na tabela do gate, nunca DENTRO da peça que o lead ou o cliente lê (mini-página, roteiro, legenda, e-mail, mensagem). Se um campo publicável não tem o dado real, a peça se reorganiza pra não depender dele, ou o gate para e pede o insumo. O que nunca acontece é publicar o marcador de pendência como se fosse texto final. Placeholder vazando pro entregável, FALHA bloqueante.
- **STATUS de entrega bate com o que o arquivo REALMENTE é.** "Pronto", "final", "PASSA" descrevem o que está no arquivo, não o que se torceu pra estar. Arquivo de teste, placeholder ou rascunho (uma tela cinza de teste, um render de amostra) nunca ganha nome de "final-...mp4" nem status "PASSA". Auditoria que afirma ver algo que não está lá ("a headline está legível" quando a suposta headline é o carimbo de teste) é auto-engano, o mesmo crime da prova sem lastro aplicado ao próprio veredito. Se o insumo bloqueia a peça, o status honesto é BLOQUEADO, nunca "passa com pendência". Status que não corresponde ao arquivo, FALHA bloqueante.
...
- **Só eu posso dizer?** O concorrente consegue assinar a mesma frase? Se consegue, é genérica. Não basta não ser frase de guru gritante: se esse gancho já rodou em anúncio de marketing-pra-especialista nos últimos 12 meses (inveja do concorrente, "você é bom demais", "o segredo que ninguém conta", "metade fechando o dobro"), é banal no nicho, reprova. Exige gancho ancorado numa cena específica e falsificável do avatar. **O paradoxo do avatar:** o SENTIMENTO dele ("ser mais um", "bom e ninguém sabe", "não cobro o que valho") é o INSIGHT interno, nunca a headline literal, porque virou trope do nicho. A headline é a CENA que produz esse sentimento (a pergunta da esposa, a planilha guardada na gaveta, o print do tráfego que fechou pouco).
- **Faz sentido sozinha, sem o resto da peça?** O título se explica dentro da própria frase, sem depender do nome do método, do mecanismo, de uma promessa dita antes ou de uma palavra abstrata órfã ("a ordem", "o segredo", "isso") que só faz sentido com a peça toda na frente. Teste do estranho: leia pra quem nunca viu a marca; se ele pergunta "que X?", reprova. `Força não salva seu joelho depois dos 40. Ordem salva.` cai aqui porque "Ordem" exige saber o mecanismo; a cura é nomear a coisa na própria frase. A régua física desta pergunta mora em `07-regua-de-titulos.md`, item 8. Critério aberto: qualquer promessa-mãe que já rodou 12 meses no nicho é banal; a salvação vem sempre da cena específica, nunca do ângulo.
...
- **Combustível (antes do comando).** Existe UMA linha de tensão de identidade ou micro-promessa concreta do que o clique abre, logo antes do CTA? CTA que vem só de concordância intelectual ("faz sentido né? então comenta") FALHA por ponte-fraca, mesmo com destino real. O leitor concorda e segue rolando.
...
## Quando não há case: o chão de credibilidade (o caminho do iniciante)
