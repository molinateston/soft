...
- Não tem ginástica de objeção.
- Não tem reunião de 1h fingindo ser "consultiva".
...
## 10.2 · O que fecha: competência demonstrada

Quem chega aqui já leu a Carta. Já está aquecido. O que fecha a venda **não é** pilha de depoimento nem ginástica de objeção. É o lead perceber, na própria conversa, que você entende o problema dele melhor do que ele entende.

Isso acontece em três momentos das 7 fases:

- **Na Descoberta**, quando você capta a essência do negócio dele rápido, com as perguntas certas.
...
## 10.3 · A cabeça do vendedor (antes da técnica)

A maior parte dos Especialistas que emperra na venda não tem problema de técnica. Tem problema de cabeça. Sem resolver isso, nenhuma das 7 fases opera. Os três bloqueios mais comuns:

| Bloqueio | Como aparece | Como reverte |
|---|---|---|
| **"Cobrar caro é antiético"** | Hesita ao falar preço, dá desconto sem pedirem | Cobrar caro é ético. Barato treina cliente errado e te impede de entregar bem. |
| **"E se o cliente desistir?"** | Evita o Isolamento (Fase 6) e o Fechamento (Fase 7), prefere "deixar ele pensar" | Cliente que precisa "pensar" geralmente não fecha. Melhor saber agora. |
| **"Não sou bom em vender"** | Vira terapeuta na call, escuta sem direcionar | Troca "vender" por "qualificar". Você não está vendendo, está descobrindo se vocês fazem fit. |

---

## 10.4 · Os 4 princípios de quem fecha

Quatro princípios separam quem fecha de quem persegue:

**1. A objeção é o caminho, não o obstáculo.** Quem ignora objeção e mira só o fechamento perde. Quem pega cada uma, traz luz e resolve, limpa o caminho até o pagamento. Objeção é sinal de que o lead está considerando, não resistência a vencer.

**2. Antecipe o ponto firme antes de apresentar.** Não gaste energia apresentando e precificando pra quem não deu sinal de que decide hoje. Antes de abrir o valor, confirme: se fizer sentido e couber, faz sentido fechar agora? Evita chegar no fim e ouvir "vou ver meu cartão".
...
## 10.5 · As premissas dos grandes vendedores (operam por trás)

A venda Soft empresta a engenharia dos melhores roteiros de venda consultiva, mas **nunca empurra jargão pro lead**. As mecânicas ficam nos bastidores. O lead vê uma conversa boa. O que opera por baixo:

| Mecânica | O que faz na venda Soft |
|---|---|
| **Perguntas em escada** (situação → problema → implicação → ganho) | Estrutura a Descoberta: leva o lead da situação ao impacto sem empurrar |
| **Reframe** (desafiar a visão) | Mostra ao lead algo que ele não tinha visto, e vira o case |
| **Tamanho do problema** (o "buraco") | Quantifica a distância entre onde o lead está e onde quer chegar |
...
## 10.6 · A espinha de 7 fases

Toda venda Soft passa pelas mesmas 7 fases. O que muda entre canais (WhatsApp, WhatsApp+Call, Reunião) é ritmo, comprimento e formato. **A ordem é fixa.**

| # | Fase | Função | Tempo no WhatsApp |
|---|---|---|---|
| 1 | **Recuo Estratégico** | Abertura consultiva. Mostra que o Especialista não tá ali pra empurrar. | 1-2 mensagens |
| 2 | **Descoberta** | Entender situação atual, tentativas anteriores, efeito colateral. | 5-10 mensagens, lead fala 70% |
| 3 | **Implicação** | Confrontar suavemente o custo de continuar como está. | 2-3 mensagens |
| 4 | **Conexão** | Mostrar que entendeu. Reformular o que o lead disse, com palavras dele. | 1-2 mensagens |
| 5 | **Apresentação** | Apresentar o método como ponte pra dor que o lead descreveu. Curto. | 2-3 mensagens |
| 6 | **Isolamento** | Antes do preço: confirmar que valor, entrega e ajuste estão claros. | 1-2 mensagens |
| 7 | **Fechamento** | Apresentar valor. Confirmar próximo passo (link de pagamento). | 2-4 mensagens |
...
### As 4 etapas do Filtro Soft

| # | Etapa | Função | Onde acontece |
|---|---|---|---|
| 1 | **Recepção** | Confirma entrega da peça prometida no comentário (Carta, Vídeo, isca) | DM do Instagram via ManyChat |
| 2 | **Apresentação** | Em 2-3 linhas: quem você é, o que faz, qual transformação entrega | DM do Instagram via ManyChat |
| 3 | **Qualificação** | Pergunta direta sobre situação atual e desejo. Sem perguntar orçamento de cara. | Transição pro WhatsApp |
| 4 | **Triagem** | Quem responde com perfil entra na agenda de fechamento. Quem não responde fica em base de remarketing. | WhatsApp |

### Regras do Filtro Soft

- **Não apresenta preço nessa fase.** Preço entra só no fechamento humano (Fase 7 das 7 fases).
- **A linguagem é a sua, não a "do bot".** Mesmo automatizada, a sequência precisa soar como você escrevendo.
- **Cada etapa tem um único objetivo.** Recepção entrega. Apresentação se posiciona. Qualificação triagem. Triagem decide.
- **O Filtro Soft substitui a reunião de descoberta gratuita.** O lead que chega no WhatsApp já passou pelo equivalente a 30 minutos de pré-call.

### O que muda no seu dia

| Antes do Filtro Soft | Com Filtro Soft |
|---|---|
| 10 leads chegam, você responde 10 manualmente | 10 leads chegam, 7 passam na triagem automática |
| Marca 5 calls | Conversa com 7 leads já preparados |
| Fecha 1 | Fecha 3-4 |
...
## 10.9 · Erros comuns na Vendas

- **Pular a Fase 1 (Recuo) e responder direto à pergunta inicial.** → Volta. O Recuo é o que tira a pressão e te posiciona como qualificador.
- **Fase 2 (Descoberta) com 1 pergunta só.** → Faz 5 a 7 perguntas curtas. Cada uma abre um dado novo.
- **Pular a Fase 6 (Isolamento) e ir direto pro preço.** → Adiciona o Isolamento. Sem isso, "vou pensar" aparece em 70% dos casos.
- **Apresentar a oferta como lista de funcionalidades.** → Reformula como ponte pra dor que o lead descreveu.
- **Follow-up de 7 dias com "ainda interessado?".** → Aceita a perda. Lead que precisa de 7 follow-ups não está pronto.
- **Reunião de 1h sem agenda.** → Cria estrutura. Descoberta 20min, Conexão 5min, Apresentação 15min, Fechamento 10min.
- **Desconto sem o lead pedir.** → Não dá. Desconto sem pedido sinaliza fragilidade do valor.
...
|---|---|---|---|
| **Escada socrática** | Perguntas que descem do fato neutro à consequência, fazendo o lead *concluir* a dor em vez de você afirmá-la | **Fase 2 · Descoberta** | Desce até a dor real do Problema Avançado e **para**. Não força degrau onde não há dor. |
| **Diagnóstico visual** | Dar forma visível ao cenário (mapa, tela, doc, resumo em bullets) enquanto ele fala | **Fase 2 · Descoberta** | Espelha o que ele disse, não pinta de vermelho o que ele não vive. |
...
## 10.10 · O Roteiro Soft, fase a fase
...
> Os valores que aparecem nas falas a seguir (R$5.000, 12x R$500, R$3.000 + R$2.000, Soft Start R$497–997 etc.) são **exemplo do caso do autor do método**, ilustram o formato do script. Cada especialista substitui pelos próprios preços (definidos pela Equação de Valor + Mapa de Valor no Cap. 2). O que importa aqui é a *estrutura da fala*, não o número.

### Fase 1 · Recuo

Abertura consultiva. Mostra que você não está ali pra empurrar. Duas, três linhas. Sem CTA no fim.

> "Vi que você leu a carta. Antes de eu te falar qualquer coisa sobre o programa, queria entender teu cenário, pra não te empurrar nada que não faça sentido. Se eu perceber que não é pra você, te falo direto. Posso te fazer umas perguntas?"

O lead que chegou defensivo relaxa aqui. O que chegou ansioso entende que vai ser uma conversa, não um pitch.
...
> "Se você resolvesse isso, o que mudava na prática?" *(ele projeta a saída)*
...
> "Se nada mudar, como você acha que vai estar daqui a seis meses?"

> "Quem mais é afetado quando isso persiste? Família, sócio, equipe?"

Aí o **termômetro**, uma pergunta única no fim:

> "[Nome], se o que eu te mostrar fizer sentido e couber no teu orçamento, tua ideia é resolver agora ou é mais pra frente?"

Como ler a resposta:

- **"Quero resolver"** → vai pra Fase 4.
- **"Depende do valor"** → "Se couber, fecha hoje?" Resposta clara, segue. Hesitou, guarda a oferta secundária pra mais tarde.
- **"Ainda tô vendo"** → é curioso, não comprador. Não apresenta a oferta principal. Devolve pra Carta ou pra um conteúdo. Sem ressentimento.
...
Mostrar que entendeu antes de apresentar. É o clique. Um bloco curto e a confirmação.
...
> "Pelo que você me falou, [parte do método] resolve exatamente [a dor específica que ele citou]. Faz sentido?"

Um reframe, algo que ele não tinha visto:

> "Uma coisa que a maioria não enxerga: [o insight que muda como ele entende o próprio problema]."

Um caso real, com nome, número e prazo, no lugar de listar o que o programa tem:

> "Pra você ter referência: [cliente] tava num cenário parecido com o teu. Aplicou [parte específica do método]. Em [tempo], chegou em [resultado mensurável]. Não é teu caso exato, mas a estrutura é a mesma."

Fecha a fase com:

> "O que mais ressoou em tudo que a gente conversou?"

Se ele citar menos de dois pontos, reforça o que ficou faltando antes de seguir.
...
- **"Sim, faz sentido"** → quando vier objeção depois do preço, é objeção real, e você resolve a pontual. O método e o ajuste já estão validados.
- **"Hmm, não sei"** → algo no método ou no formato não bateu. Volta pra Conexão. Fechar aqui é forçar.

Se aparecer desculpa decorativa aqui, antes do preço:
...
> "Preciso falar com [sócio, cônjuge]." → "Faz sentido. Quer que eu te mande um resumo com o método, o valor e o cronograma pra você compartilhar? Facilita a conversa de vocês."

**Nunca revela preço com dúvida aberta.**
...
Se confirmar: manda o link, confirma os próximos passos (primeira sessão agendada, suporte ativado), encerra. Sem cerimônia.

Se hesitar, **uma jogada de encaminhamento por vez, nunca duas juntas:**

1. **Condicional**, só se o único freio é o valor:

> "Posso fazer diferente: R$3.000 agora e R$2.000 quando [o primeiro resultado]. Ou em até 60 dias. Facilita?"

2. **Oferta secundária**, uma vez só, se recusou a condicional:

> "Última alternativa: o Soft Start, por R$[497 a 997]. Você monta sozinho, com o método e o copiloto. Sem acompanhamento ao vivo. Fecha?"
...
Depois de todo fechamento positivo, a **indicação**:

> "[Nome], você conhece alguém no mesmo momento que você tava, tentando resolver [o problema] e não conseguindo?"

Se der o nome: "Me passa o contato. Te mando uma mensagem pronta que você encaminha pra ele?"

---

## 10.11 · As objeções, no tom Soft

Sempre isola antes de responder, quando dá: **"É só isso ou tem mais coisa emperrando?"** E devolve com pergunta de comando, nunca com súplica.

> **"Tá caro."**
> "Caro comparado com quê? Com continuar [o problema] por mais [tempo]? Se não cabe à vista, tenho condicional: parte agora, parte quando [o resultado]. Facilita?"

> **"Não tenho dinheiro agora."**
> "Entendo. Se eu fizer caber no orçamento, você avança hoje, ou não é só a grana?"

> **"Vou pensar."**
> "Claro. Pensar sobre o quê especificamente? Se for o método, resolvo agora. Se for o investimento, resolvo agora. Se for outra coisa, me fala que é."

> **"Preciso falar com o sócio / cônjuge."**
> "Faz sentido. Quando vocês conversam? Se quiser, faço uma call rápida com vocês dois. Ou te mando um resumo pra você levar."

> **"Funciona mesmo?"**
> "Funciona pra quem aplica como foi pensado. Se é pra você, eu descubro nas perguntas. O que você já tentou antes?"

> **"Já tentei e não deu certo."**
> "Por isso faz sentido. O que você tentou ensinava [a solução errada]. Aqui é o oposto. Você não falhou, tentou o método errado."

> **"Não tenho tempo."**
> "Por isso o formato é esse. Separa [X] por semana. Consegue ou não?"

> **"Parece simples demais."**
> "É simples, não fácil. Simples é poucos passos. Fácil é pouco esforço. Topa o esforço?"

> **"Tem desconto?"**
> "Esse já é o menor valor. Não abaixo porque não quero te filtrar pelo desconto."

Se a mesma objeção volta duas vezes, é outra coisa emperrando. Pergunta direto: **"Acho que tem algo além disso. O que é?"** Se ele não consegue nomear, é curiosidade, não comprador. Encerra com leveza.

---

## 10.12 · Frases de poder, por situação

Uma por vez, no momento certo. **Não em sequência.**

| Situação | Frase |
|---|---|
| **Lead chega defensivo** | "Não vim te empurrar nada. Vim entender se faz sentido. Se não fizer, te falo direto, e você também." |
| **Lead pede "me mostra" antes da hora** | "Posso te mostrar. Mas se eu mostrar agora sem entender teu contexto, você vê features. Se eu entender cinco minutos primeiro, você vê o que resolve o teu caso. Topa começar pelo contexto?" |
| **Lead concordando com tudo (suspeito)** | "Você tá concordando demais. Onde tá a dúvida que ainda não saiu?" |
| **Lead esquivando de números** | "Me dá um número aproximado, mesmo que chute. Sem isso eu fico no genérico." |
| **Lead pergunta o que te diferencia** | "Não vou te listar feature. Te conto o que a gente não faz, geralmente é mais útil." |
| **Lead sumiu há cinco dias** | "Sumiu. Tá resolvido por outro caminho, ou tá só fora de timing? Sem rodeio, qualquer das duas é resposta." |
| **Lead pede desconto pesado** | "Não trabalho com última oferta. O preço é esse porque entrega esse resultado. Se não couber, te recomendo voltar quando couber, sem nada me devendo." |
| **Lead claramente fora do perfil** | "Sendo direto: não acho que faz sentido pra você agora. Quando [a situação mudar], a gente conversa." |

---

## 10.13 · Os 3 níveis no fechamento
...
*(Os valores acima são exemplo do caso do autor do método; o que é método é a ordem do meio pra fora e a regra de não apresentar como cardápio.)*

**Nunca apresenta os três como um cardápio.** Isso vira esteira e confunde. Um por vez, conforme a conversa pedir.

---

## 10.14 · Adaptação por canal

O script acima é WhatsApp puro, que serve pra ticket de entrada e médio. Pra ticket mais alto:

- **WhatsApp + call:** o texto cobre as Fases 1 a 3 (qualifica e passa o termômetro). A passagem é "Faz sentido a gente conversar 20 minutos pra eu te mostrar como isso se aplica no teu caso? Tenho [horário] e [horário]." As Fases 4 a 7 acontecem na call, que abre com o acordo de sinceridade da Fase 1.
- **Reunião:** 40 a 60 minutos, sem slides, tom de conversa. Blocos: entender 20 minutos, conectar 5, apresentar 15, fechar 10. A espinha é a mesma, só com mais espaço.

**A ordem das 7 fases não muda. O que muda é o ritmo e o comprimento.**
