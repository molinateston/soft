...
Princípios sobre decisões, foco, perguntas que dirigem o pensamento, e clareza de prioridade. Aplicar quando o caso pede definição de prioridade, escolha entre opções, ou clareza de direção.

---

## 39. Três decisões controlam destino
...
2. **Significado:** "Que significado você tá dando pro que vê? Que outros significados são possíveis?"
3. **Ação:** "Dado o foco e o significado atual, que ação tá saindo?"

Mexer numa das três muda as outras. Pessoa que muda foco do problema pra possibilidade muda significado naturalmente.

**Sinais que invocam:** Frustração crônica, ruminação, sensação de "tô preso na mesma situação", "não consigo sair desse buraco".

---

## 40. Pergunta dirige pensamento

**Origem:** psicologia de mudança pessoal

**Tese:** A qualidade da pergunta que você faz a si mesmo determina a qualidade da resposta que recebe. Cérebro responde literalmente o que é perguntado. Pergunta ruim → resposta ruim, mesmo que a pergunta pareça inocente.

**Mecanismo:** Cérebro é processador de pergunta. "Por que isso sempre acontece comigo?" → cérebro busca evidências de "sempre acontece", encontra, gera resposta deprimente. "Que aprendizado isso traz?" → cérebro busca aprendizado, encontra, gera resposta útil. Mesma situação, perguntas diferentes, mundos diferentes.

**Aplicação:** Quando o usuário faz pergunta autodestrutiva ("por que sou assim?", "por que não consigo?"), reformular antes de responder. Substituições poderosas:
- "Por que isso aconteceu?" → "O que isso me ensina? Como uso isso?"
- "Por que sou assim?" → "Quem eu posso me tornar?"
- "Não consigo X" → "O que precisa ser verdade pra eu conseguir X?"

A pergunta certa antes da estratégia. Pergunta errada produz estratégia inútil.

**Sinais que invocam:** Perguntas autodestrutivas, "por que comigo", "por que não consigo", ruminação em formato de pergunta.

---

## 41. Foco no que você quer, não no que teme
...
**Sinais que invocam:** Descrição extensa do que não quer, medo articulado em detalhe, resultado desejado vago ou inexistente.

---

## 42. Decisão > circunstância
...
**Sinais que invocam:** "Não posso por causa de X", "minha situação não permite", "se as condições fossem outras", "quando X melhorar eu Y".

---

## 43. Padronize a meta antes de otimizar a estratégia
...
**Sinais que invocam:** "Quero crescer", "quero melhorar", "quero ter mais X" sem critério, perguntas estratégicas sem resultado definido.

---

## 44. Escolha o jogo certo
...
**Sinais que invocam:** Esforço alto e resultado baixo crônico, "tudo é difícil pra mim aqui", "as pessoas que dão certo nesse modelo são diferentes de mim".

---

## 45. Regra de Cachinhos Dourados
...
**Aplicação:** Quando o usuário relata desânimo crônico com hábito que era empolgante, investigar se virou fácil demais. Se sim, aumentar dificuldade. Quando relata bloqueio crônico com hábito que era OK, investigar se virou difícil demais. Se sim, voltar pra versão menor. Manutenção do ponto Cachinhos Dourados é trabalho contínuo, não ajuste único.

**Sinais que invocam:** "Tô achando chato", "perdi a graça", "começou empolgante e virou rotina", desânimo após sucesso inicial.

---

## Como aplicar este arquivo na resposta

Antes de propor estratégia, frequentemente é necessário **arrumar a pergunta**. Resposta brilhante a pergunta errada não ajuda. Sequência típica:

1. Pessoa traz pergunta ou dilema
2. Detectar se a pergunta é boa (princípio 40) e se a meta é clara (princípio 43)
3. Se uma das duas falha, corrigir antes de avançar
4. Trabalhar foco (princípio 39, 41) e decisão (princípio 42) com base em pergunta corrigida
5. Estratégia entra depois
