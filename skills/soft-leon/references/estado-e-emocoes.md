...
Princípios sobre estado neurofisiológico, controle emocional e fisiologia da emoção. Aplicar quando o caso pede manejo de emoção, recuperação de estado de baixa, ou controle de humor que afeta performance.

---

## 32. Estado neurofisiológico controla comportamento
...
**Aplicação:** Quando o usuário diz "não consigo agir / decidir / falar", primeiro pergunta sobre estado, não sobre conteúdo. "Em que estado você está agora? Que emoção predomina?" Estado ruim → não trabalhe estratégia. Trabalha estado primeiro (técnicas dos princípios 33, 36, 37). Depois retoma a estratégia.

**Sinais que invocam:** "Não consigo agir", "tô paralisado", "tô travado", "minha cabeça tá nublada", "não sei o que sinto".

---

## 33. Fisiologia altera estado

**Origem:** psicologia de mudança pessoal

**Tese:** Postura, respiração e expressão facial mudam estado em segundos. O caminho mais rápido pra mudar como você sente é mudar como você está fisicamente.
...
## 34. Emoções negativas são sinais, não inimigos
...
**Sinais que invocam:** "Quero parar de sentir X", "essa emoção tá me atrapalhando", "não devia estar sentindo isso", luta contra a emoção em vez de leitura.

---

## 35. Vocabulário transforma estado
...
**Tese:** Você pode associar um estímulo específico (gesto, palavra, música, lugar) a um estado de poder. Quando precisar do estado depois, ativa o estímulo e o estado vem.

**Mecanismo:** Pavlov com você mesmo. Você induz estado de poder (lembrando momento de pico, fisiologia de confiança, respiração profunda) e ao mesmo tempo aciona estímulo único (apertar punho de forma específica, ouvir música específica, dizer frase específica). Repetição associa estímulo → estado. Depois, estímulo dispara estado mesmo em circunstância adversa.

**Aplicação:** Quando o usuário precisa de acesso confiável a estado de confiança em situação previsível (apresentação, reunião, decisão difícil), ensinar a ancorar. Etapas: (1) lembrar momento de pico de confiança, reviver corporalmente; (2) intensificar; (3) acionar estímulo único no pico; (4) repetir 5-10 vezes. Antes da situação real, aciona o estímulo. Estado vem.

**Sinais que invocam:** Necessidade de performance em momento específico, ansiedade pré-evento, "preciso conseguir entrar no clima X".
...
**Sinais que invocam:** "Queria ter a calma de X", "como ela consegue parecer tão segura", "ele entra na sala e domina".

---

## Como aplicar este arquivo na resposta

Estado é precondição. Antes de trabalhar estratégia, conteúdo ou plano, **verificar estado**. Pessoa em estado ruim não consegue executar bom plano. Pessoa em estado bom executa até plano mediano.

Sequência de aplicação típica:

1. Reconhecer o estado descrito (não julgar)
2. Identificar se precisa de intervenção física (princípio 33), reframing (36) ou leitura do sinal (34)
3. Trabalhar o estado
4. Só depois retomar a discussão estratégica
