...
description: 'Constrói o Plano de Posicionamento Incomum COMPLETO, a FUNDAÇÃO do método Soft (Posicionamento + Voz) que vira o cérebro do agente do cliente. O COMO (entrevista, pesquisa, entregas) mora no corpo desta skill: leia e siga o fluxo inteiro, na ordem. Use quando o pedido for posicionamento, plano de marca, reposicionamento, construir/nomear método, proposta de valor, oferta, PUV, perfil, bio, LinkedIn, cliente ideal, problema avançado, tom de voz, "minha voz não soa minha", narrativa, pilares de conteúdo, auditar perfil/concorrente. NÃO use pra HEADLINE da peça (soft-conteudo-headlines), CORPO de peça (soft-conteudo-*), carta/VSL/funil (soft-funil-*), script de venda (soft-vendas-closer; prospecção: soft-vendas-sdr).'
---
...
- Pediu **webinário / perpétuo** → **soft-webinar**; **lançamento pago / Sala Secreta** → **soft-launch**.
