...
## 4.1 · Por que esse ativo vem antes do feed

Sem Carta ou Vídeo no ar, conteúdo público não tem destino.

Imagina o cenário. O Especialista produz um Reel que viraliza, um Carrossel que bate 5k de salvamento, um Stories que engaja. O lead se interessa. Manda DM: "como funciona seu trabalho?".
...
## 4.3 · Como escolher entre Carta e Vídeo
...
| Atrito de produção | Médio (escrita) | Médio-alto (gravação + edição) |
| Atrito do lead | Baixo | Médio |
| Conversão | Boa em tickets baixos a médios | Melhor em tickets médios a altos |
| Revisão | Rápida (edita texto) | Cara (regrava) |
| Quando preferir | Escreve melhor que fala | Se comunica melhor em vídeo |

Na prática, decida por perfil:
...
A lógica por trás: quanto mais alto o ticket, mais profundidade o lead precisa pra decidir, e o vídeo entrega presença que o texto não entrega. Quanto mais baixo o ticket, menos atrito o ativo pode pedir, e o texto se lê em qualquer lugar, em silêncio, sem fone.
...
Diferente do vídeo, na Carta o leitor pode parar a qualquer frase. No vídeo, ele é carregado pela narração; na Carta, ele está sozinho com o texto. Se uma frase é fraca, genérica ou longa demais, ele fecha a aba. Não há narração que o segure. Por isso a regra é dura: cada frase precisa puxar pra próxima.

O teste único: o cliente certo pensa "isso fala diretamente comigo" na primeira linha, e "finalmente alguém que entende" no final.
...
|---|---|---|
| 1. Promessa, apresentação e filtro | Espelha o cliente certo, promete o que ele vai entender, filtra quem não é | Hook + filtro |
| 2. Diagnóstico | Nomeia o Problema Avançado, as soluções tentadas, o efeito colateral que criaram | Diagnóstico + Vilão |
...
A Carta vive ou morre na experiência visual de leitura:

- Parágrafos de 1 a 3 linhas, no máximo. Zero blocos densos.
- Frases isoladas em momentos de alto impacto. No máximo 3–4 na Carta inteira.
- Pergunta retórica curta a cada 3–5 parágrafos pra reengajar. No máximo 8 palavras.
- Espaço em branco generoso entre os blocos.
- Zero subtítulo. Subtítulo quebra o fluxo e transforma Carta em relatório.
...
## 4.5 · Vídeo Minimalista

Vídeo de 7 a 12 minutos, gravado uma vez, hospedado em página simples, assistido sob demanda. Substitui a Carta quando o Especialista comunica melhor falando que escrevendo, ou quando o ticket sobe e o lead precisa de mais profundidade pra decidir.
...
A abertura desafia o que o lead acredita. O meio constrói o diagnóstico. O fim apresenta o método como o caminho diferente. Abertura que não instala tensão = lead desengaja nos primeiros 90 segundos.
...
Seis elementos mínimos:

- **Headline:** promessa em 1 linha.
- **Subheadline:** pra quem é + filtro.
- **Pra quem é:** 3–5 bullets de filtragem.
- **Vídeo:** embed (Loom, Vimeo, YouTube não listado).
- **Provas:** prints com contexto.
- **Botão único:** CTA pro WhatsApp.

A página não argumenta. O argumento está dentro do vídeo. A página apresenta a promessa, filtra na entrada, mostra prova e redireciona.

---

## 4.6 · Filtro Soft: a ponte Feed → Carta/Vídeo

O Filtro Soft é a ponte entre o conteúdo do feed e o ativo Carta/Vídeo.

Fluxo padrão: a pessoa comenta a palavra-chave no post → o ManyChat envia automaticamente a Carta ou o link do Vídeo → o bot faz um follow-up simples 24–48h depois ("Conseguiu assistir? Alguma dúvida?").

Não é pilar do método. É ferramenta operacional que acelera a entrega do ativo. Configuração mínima: 1 palavra-chave → 1 mensagem com o link → 1 follow-up. Não precisa de sequência complexa.
...
Fluxo: Reel ou Carrossel atinge público qualificado → CTA "comenta [palavra-chave]" → a entrega automática dispara → o seguidor recebe a isca ou cai direto no funil. A automação roda no ManyChat ou no GHL (GoHighLevel). Configuração mínima: 1 palavra-chave, 1 disparo, 1 follow-up. Sem sequência complexa.

---

## 4.8 · Erros comuns na Carta / Vídeo

**Carta com 15 páginas.** Corrige: corta. 4–7 minutos de leitura é o máximo.

**Preço escondido em jogos ("descubra o preço aqui").** Corrige: tira o preço da Carta inteiro. Trata no WhatsApp.
