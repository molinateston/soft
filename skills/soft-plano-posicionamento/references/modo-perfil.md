...
Se a resposta de qualquer uma for "não", **não avança**, manda invocar a skill `soft-plano-posicionamento` antes.
...
|---|---|
| Definir cliente ideal e Problema Avançado | `soft-plano-posicionamento` (skill) |
...
2. **As 3 perguntas do gate** (`crivo/03-gate-cub.md`) na Bio (a tese/promessa) e no Destaque MÉTODO: dá pra ver? dá pra falsificar? E a mais dura: **só você pode dizer (o concorrente do nicho não assina)?** Bio ou destaque que cabe em qualquer concorrente reprova.
