...
1. Imagem no rodapé: abrir ou quebrar visualmente; opção mais usada.
2. Enquete: fazer o leitor se posicionar.
...
- Usar 5 a 8 tipos no carrossel, não obrigatoriamente todos os nove.
- Abrir com impacto, tensionar, provar e fechar no CTA.
- Nunca repetir o mesmo tipo em cards consecutivos.
- Prova sem tensão anterior perde força.
- Cada card tem um trabalho.

## Conferência visual por critério

- Cabeçalho: provar no mosaico avatar redondo + nome + selo azul + handle.
- Cor: provar que só palavras-chave estão verdes.
- Numeração: provar ausência de N/total e números de card.
- Copy: comparar cada tela com o respectivo slide da fonte.
...
- IMAGEM FORTE em no minimo 4-5 dos 9 slides, distribuida no arco (capa,
