...
Aviso de escopo: aqui não tem framework de estrutura de argumento. Este método usa a espinha APSD (Atenção, Problema, Solução, Decisão), e ela mora nas skills de conteúdo. Este arquivo é só a FORMA no celular: quantas linhas, quanto respiro, que tamanho de frase. Não decide o que dizer, decide como o texto se apresenta na tela pequena.
