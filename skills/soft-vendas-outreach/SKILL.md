...
`references/EXEMPLO-FIM-A-FIM.md` (o caso fictício de ponta a ponta) · `references/recorte-e-lista.md` · `references/motivos-e-pesquisa.md` · `references/mensagem-e-canal.md` · `references/retomada-e-volume.md` · `references/gate-da-abordagem.md` · `scripts/lint_copy.py` (o anti-IA em código, rode no shell quando o ambiente permitir) · `shared-references/filtro-anti-ia/` (a régua anti-IA escrita, pro motor que não roda o lint).
