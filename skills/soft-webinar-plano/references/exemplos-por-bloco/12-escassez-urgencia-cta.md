...
> Ressalva de atribuição: o "Webinar C" do corpus do autor do método tem voz única que se identifica como **o autor do case de odontologia** (dentista). Mecanismos com dono: escassez de bônus "15 primeiros" com confirmação automática = máquina da operação-referência; timer "rigged" e a demonização do "maybe" = webinar de referência; o frame "viver comigo ou ver pelo Instagram" = pele o autor do case de nutrição.

---

## O que este bloco precisa fazer (síntese das premissas)

A regra-mãe do corpus: a escassez dos campeões é CRÍVEL E AUDITÁVEL - nunca recai sobre uma mentira. Os três desenhos validados: (1) escassez de BÔNUS, não de produto (máquina da operação-referência: o curso não fecha; o que evapora são os bônus dos 15/10 primeiros, com confirmação automática do sistema - "parabéns, você está entre os 15 primeiros"); (2) escassez de CONDIÇÃO/PREÇO (webinar de referência A: a oferta da sessão acaba com a aula, mas o produto continua comprável por mais caro - "você até consegue comprar depois, mas no mínimo por 997"; webinar de referência C: 10 vagas só no preço de 1.997; a autora do case de arquitetura: cupom até 23:59); (3) escassez MECÂNICA terceirizada (webinar de referência: timer "rigged up" que fecha sozinho, com reason-why operacional). Segundo trabalho: converter intenção em ação MOTORA antes do link existir - "já vai pegando o seu cartão, se é virtual já abre no celular" - para que no pico emocional não haja janela de racionalização. Terceiro: narrar a corrida ao vivo (vagas caindo 12→11→9→8→4; compras anunciadas no chat; "parabéns fulana, bem-vinda ao time") - a compra alheia vira pressão social audível e prova de manada. Quarto: o custo da inação é tornado concreto (R$200 mais caro amanhã; "é fácil ficar no Brasil e ganhar pouco"; o concorrente usando enquanto você não usa). Quinto: o CTA é operacional e sem fricção - botão + link no chat + fallback narrado clique a clique, com troubleshooting ao vivo. Sexto: vários campeões posicionam um pico EMOCIONAL depois do preço (a história da mãe da autora do case de arquitetura; o "barco saindo" do autor do case de nutrição; o takeaway do autor do case de odontologia) - a decisão é tomada em estado alterado, e quem não compra escolhe em público a estrada pior. E o presente prometido na abertura é pago aqui - o loop de retenção fecha dentro do CTA ("só quem ficou até o final vai ganhar").

---

## Exemplo por exemplo

### Webinar de gestão (8 dígitos) (operação-referência, ed. A - modelo-mestre 8 dígitos) - escassez por velocidade com confirmação de sistema
...
### 5N (o estrategista da operação-referência) - mesma máquina; o chat como placar de vendas
...
### GA ed.2 (operação-referência) - contagem regressiva narrada + desconto por canal
...
### GA ed.1 (o estrategista da operação-referência) - a narração de vagas mais longa do corpus + empurrão moral final

**Trecho literal:**

> "Já vai separando o cartão? Pega aí o seu cartão, já fica no jeito para você não reclamar e falar: Ah, [host], não deu tempo de me inscrever."
...
### Case de arquitetura (a autora do case de arquitetura) - deadline de relógio + pico emocional DEPOIS do preço
...
> (fechamento emocional 1 - frase do mentor, com crédito ao o mentor citado no case de arquitetura) "Você é a pessoa que vai falar pro seu filho: \"Faz porque eu fiz\" ou você vai ser a pessoa que vai falar: \"Faz porque eu não fiz?\" […] Cara, isso, isso me, ó, tô arrepiada, gente."
...
### Webinar de referência A (pele Soft: nutrição / o autor do case de nutrição) - urgência de SESSÃO, o desenho canônico pra perpétuo
...
**O que é decalcável vs do nicho:** decalcável: o desenho inteiro é o gabarito de escassez pra webinar perpétuo (condição de sessão + diferença de preço real + presente no checkout). Do nicho/dono: o barco/arquibancada e o tom "bicho" são da pele o autor do case de nutrição.

---

### Webinar C (corpus do autor do método - voz o autor do case de odontologia, dentista) - 10 vagas de PREÇO com contagem ao vivo até a última frase
...
> (última frase do webinar) "tá uma vaga ainda, o autor do case de odontologia, nos 10, última vaga dos dez, não perde, que esse preço é só para agora tá. Tamo junto galera, forte abraço para vocês"
...
### webinar de referência #1 (One to Many) - escassez mecânica terceirizada: o timer que decide sozinho
...
### webinar de referência #2 (Product E-Class) - o timer como assassino do "maybe"
...
- [ ] **Escassez crível e auditável, nunca sobre mentira.** Três desenhos validados: bônus pros N primeiros (produto não fecha - operação-referência), condição/preço da sessão (comprável depois por mais caro - webinars de referência A/C, a autora do case de arquitetura), mecanismo terceirizado com reason-why (timer - webinar de referência). Nenhum campeão mente estoque.
...
- [ ] **Custo da inação concreto** (R$200 mais caro amanhã; "vai ficar mais caro, e de fato é"; perda dupla do modelo; "é fácil ficar ganhando pouco").
...
- **Urgência por gritaria, sem reason-why.** O modelo racionaliza ("matar o maybe"), a operação-referência mecaniza (sistema), a autora do case de arquitetura emociona (identidade) - nenhum simplesmente grita "CORRE!" sem estrutura por baixo.
- **Empilhar escassez e desconto na mesma moeda.** A máquina da operação-referência separa: o desconto remove a objeção de preço (todos levam), a corrida é pelos bônus (15 primeiros). Misturar dilui as duas urgências.
- **Pro perpétuo: deadline de calendário fake.** O desenho validado é o do webinar de referência A - condição da SESSÃO com diferença de preço real e auditável. Timer de calendário falso em evergreen é o erro que queima a máquina.
- **Decalcar forma com dono** ("rigged timer" e o frame do maybe são do webinar de referência; "parabéns, você está entre os 15" é operação-referência; barco/arquibancada é pele o autor do case de nutrição). Extrair o desenho, reconstruir na voz do especialista.
...
- **Ao vivo, máquina de turmas** (caso de 8 dígitos, 5N, GA ed.2, GA ed.1): bônus pros 15/10 primeiros com confirmação de sistema + contagem narrada.
- **Ao vivo, evento único** (o case de arquitetura): deadline de relógio (23:59) + cupom + pico emocional pós-preço.
- **Perpétuo** (webinar de referência A): condição da sessão ("se essa aula acabar, acabou") + diferença de preço real - o único desenho honesto pra loop.
- **Ao vivo, vagas de preço** (webinar de referência C): 10 unidades no preço com contagem até a última frase.
- **Evergreen gravado** (webinar de referência #1 e #2): timer mecânico com reason-why + reframe do maybe.
