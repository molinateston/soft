...
> **Como esta skill usa este arquivo (ENCENAÇÃO, não desenho).** Aqui o roteiro ENCENA na tela a oferta que já foi DESENHADA na `Etapa PLANO/OFERTA (desta skill)` (o que existe: produto, stack, garantia do cardápio, ticket, nomes). Este arquivo é a **coreografia de palco** da fase Ação: a ordem em que o preço cai, a fala de cada movimento, o que aparece na tela. Se a oferta (stack/preço/garantia/PUV) ainda NÃO existe, ela se desenha primeiro em `Etapa PLANO/OFERTA (desta skill)`; aqui você só a apresenta. Não invente número, item, garantia ou preço: o que falta vira `[A CONFIRMAR]` e volta pro desenho.
...
- Sintoma de que você está no lugar errado: se a pergunta é "este item entra no pacote?", é DESENHO (Etapa PLANO/OFERTA (desta skill)). Se é "em que segundo e com que palavra eu mostro isso?", é aqui (encenação).
...
- A **régua operacional de canal por ticket** (WhatsApp/ligação/SDR+closer, tags, filas, CRM) está na `Etapa MENSAGENS (desta skill)` e o 1:1 humano na skill `soft-vendas-closer`. Aqui (§11) só o que muda **dentro do webinar** pela faixa de preço: âncora, destino do CTA, escassez, garantia.
...
4. **Super-garantia 90+90 (a do corpus estudado).** Em escada: "Aplica por 90 dias. Se não tiver resultado, eu te dou uma consultoria pessoal. Aplica mais 90 dias. Se ainda assim não tiver resultado, eu devolvo o seu dinheiro E te dou R$6.000 pelo tempo que você perdeu." **Por que funciona:** (a) reverte 100% do risco e ainda paga pelo tempo - a única explicação que sobra pra não comprar é "eu não vou aplicar", e ninguém quer se assumir assim; (b) é difícil de acionar **honestamente, de propósito**: quem aplicou de verdade por 180 dias teve resultado, e a consultoria no meio da escada existe pra garantir isso; (c) o valor do "pelo tempo perdido" é SLOT do nicho (R$6.000 é o número do corpus estudado) - grande o bastante pra doer no player, crível o bastante pra não virar teatro. Variante por nicho (nutrição): "90 dias; se aplicar e não der, devolvo o dinheiro **e pago o dobro do meu bolso**, pelo tempo perdido."
...
- Exemplo arquitetura (Aluna 80k; biblioteca bloco 12): *"você vai ser a pessoa que fala pro seu filho 'faz porque eu fiz' ou a que fala 'faz porque eu não fiz'?"* (frase com crédito ao mentor Wendel Carvalho) - seguida da história real da mãe, chorando ao vivo. O choro genuíno neutraliza o cinismo pós-pitch; o que não se fabrica é a emoção real.
- Exemplo nutrição (o especialista do corpusA; bloco 12): *"o barco tá saindo; você só tem uma escolha - continua sozinho batendo cabeça, ou vem comigo na direção certa. Você vai ver resultados lindos todo dia, mas só pelo Instagram - eles nunca vão ser os seus."* (viver vs assistir da arquibancada.)
...
**(c) A aplicação inverte o desejo.** Pro high-ticket, formulário de aplicação > link direto, por dois motivos. **Pré-qualifica** - o comercial não gasta hora com quem está fora do perfil. E **inverte o jogo psicológico**: quem preenche uma ficha pra ser "aceito" deseja mais, porque o esforço de entrar é prova de valor - fica intrínseco que "se eu não te chamar, você não foi aceito" (corpus). A pessoa para de pedir o produto e passa a te vender por que merece ser chamada.
