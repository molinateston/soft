...
## A tese que confirma a hierarquia do corpus estudado

Fladlien coloca o webinar como o segundo meio mais poderoso de educar, atrás só da interação presencial cara a cara. Isso confirma a correção do corpus estudado (10/jun): **nada supera o 1:1; o webinar é o mais forte do 1:muitos.** O porquê econômico: o webinar atrai os 20% do mercado que detêm 80% do poder de compra (Pareto), quem leva educação a sério e investe sério. A lei que ele tira disso: quanto mais você serve, mais você pode vender. No Soft isso não é frase de palco, é a justificativa de servir de verdade no conteúdo (ver "as 2 vendas" abaixo).
...
A peça que protege a oferta: a "estratégia" do CVSC é o **O QUÊ, não o como-fazer manualizado.** Isso casa exatamente com a correção do corpus estudado (cap 2): dar aula é entregar problema, solução, o quê e por quê, mais a troca de crença, sem o passo a passo de execução que é o que abre o loop do produto (a Faca Soft). O CVSC é a forma fina de rodar isso passo a passo: cada etapa ensinada de verdade no nível de entendimento, retendo só o braço.
...
- Melhore o mesmo webinar ao longo do tempo. **EXEMPLO (Fladlien):** o mesmo webinar evoluiu de 1,7M para 2,6M para 3M em vendas, só por refinamento. (Casa com o perpétuo do corpus estudado: a sessão gravada é ativo que se melhora, não evento que se descarta.)
