...
- **EXEMPLO de outro nicho (gestão):** s.66-69 *"4 PASSOS"* revelados 1 → 1+2 → 1+2+3 → completo · s.161-164 o mega-mapa "Jornada Gestão Ágil 2.0" entrando fase por fase. **(O mega-blueprint de 7 fases × 7 passos é o oposto de baixa complexidade, referência do que NÃO copiar no Soft.)**
