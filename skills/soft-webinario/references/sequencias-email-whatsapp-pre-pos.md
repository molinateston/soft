# Sequências de email e WhatsApp - pré e pós webinar

> **Quando consultar:** Etapa 4 do fluxo - depois das páginas prontas. Pré-requisito: roteiro do webinar e páginas (references 2 e 3) completos.
...
- DURANTE O WEBINAR
- PÓS-WEBINAR
- Variantes por escopo de webinar
- Princípios de copy nas sequências
- Configuração técnica
- Métricas-alvo da sequência
- Checklist antes de subir as sequências
- Notas operacionais
...
- **WhatsApp:** lembrete curto, urgência real-time, conversa próxima, alta abertura
...
|---|---|
| Só email | 30,98% |
| Email + WhatsApp | **47,20%** |

 **+54% de taxa de participação** só de duplicar o canal de notificação - sem mexer em copy, sem mexer em mídia.
- **Porquê.** É a alavanca de maior ROI provado pra show-up: mais barata que melhorar copy, mais previsível que melhorar tráfego, e de custo marginal quase zero depois de montada. Por isso o Webinar Soft **nasce com WhatsApp no funil** - não é "nice to have", é a maior alavanca individual de comparecimento conhecida no corpus. A sequência paralela email+WhatsApp desta reference existe pra capturar exatamente esse ganho.
- **Fala literal de campo (marca o tamanho do efeito):** *"WhatsApp caiu o comparecimento pela metade só com e-mail, WhatsApp é obrigatório."* É a mesma medição vista de cima pra baixo: tirar o WhatsApp do funil **divide o show-up por dois**. Não é otimização de margem, é a diferença entre meia sala e sala cheia. (origem: corpus de webinar Soft.)
...
```
PRÉ-WEBINAR
├─ Email 1 + WhatsApp 1 (no cadastro - boas-vindas + opt-in)
├─ Email 2 + WhatsApp 2 (24h antes - preview + lembrete)
├─ Email 3 + WhatsApp 3 (1h antes - última chamada)
└─ WhatsApp 4 (5min antes - link da sala)

DURANTE
├─ WhatsApp durante (mensagem 1: chegou? entra)
...
├─ Email 7 + WhatsApp 8 (48h depois - last call)
├─ Email 8 + WhatsApp 9 (72h depois - fechamento)
└─ Email 9 (5-7 dias - downsell ou re-engajamento)
```

> Total: 9 emails + 9 WhatsApps. Pode reduzir pra 5+5 em audiências menos quentes ou 12+12 em lançamentos grandes.

> **⚠️ Esta é a régua de timing. O QUEM recebe o quê no pós é decidido pela tag por % assistido** - quem `viu-oferta` recebe a sequência de fechamento (Msg 5→9); quem saiu antes recebe nutrição/reconvite; quem `nao-compareceu` recebe só reconvite. Ver a seção "⭐ O GATILHO QUE GOVERNA O PÓS INTEIRO" mais abaixo antes de montar o pós.
...
```
Assunto: Confira os dados da sua inscrição no [Nome do Webinar]

Olá [primeiro nome],

Confirmado. Vou te ver no [data] às [hora] no [Nome do Webinar].
...
2) Adiciona no calendário:
   [link Google Calendar] | [link Apple] | [link Outlook]

3) Vem com [pré-condição leve - caderno, perfil aberto, calculadora]
   Não vou pedir, mas você vai querer.

A sessão vai ser densa. Eu não vou enrolar. Você sai com o método 
completo + casos reais + o caminho pra implementar.
...
Tô separando algumas coisas que só vão pelo WhatsApp 
(quem só ficar no email perde).
...
```
Assunto: Amanhã, [hora] - o que prepara o caminho

[Primeiro nome],

Amanhã às [hora] a gente se vê.

Antes, te entrego um pedaço do método pra você chegar no webinar com 
contexto, não com curiosidade vazia.

[Insight curto, 4-6 frases - pode ser uma das provas do roteiro,
um caso resumido, ou a Premise reformulada]

Esse insight é a porta de entrada. No webinar a gente entra na sala 
inteira: como [resultado] em [tempo curto] mesmo sem [objeção].

3 coisas que separei pra te entregar amanhã:

✓ [Bullet 1 da página de cadastro]
✓ [Bullet 2]
✓ [Bullet 3]
...
P.S.: Confirma teu WhatsApp no link [WhatsApp] se ainda não confirmou.
...
### WhatsApp durante (mensagem opcional)

**WHATSAPP DURANTE 1** - no minuto ~25 (meio do bloco MECANISMO)

**Função:** reativa quem entrou e se distraiu; segura quem pensa em sair antes da parte forte.

```
Tá no webinar agora?

Daqui [N min] vou apresentar o método completo. 
Não sai antes - a parte forte tá vindo.
...
**Função:** avisa, **só pra quem confirmou WhatsApp**, que a oferta abriu, com link direto do checkout e o prazo do bônus de ação rápida.
...
> Aqui está a **maior parte do dinheiro**. Pouca gente compra no minuto exato da oferta. A sequência de pós é o que recupera quem ficou em cima do muro - e cada mensagem ataca um motivo diferente de não ter comprado.

### ⭐ O GATILHO QUE GOVERNA O PÓS INTEIRO: a tag por % assistido
...
- **As faixas e o que cada uma dispara:**

| Faixa assistida | Tag | Estado | Sequência de pós que recebe |
|---|---|---|---|
| Não compareceu | `nao-compareceu` | frio | **Reconvite** pra próxima sessão - NÃO recebe oferta ainda |
| 0–25% (entrou e saiu cedo) | `assistiu-0` | baixo | Reconvite + "o que você perdeu" - fazer voltar e assistir |
| 25–75% (pegou o problema, saiu antes da oferta) | `assistiu-50` | médio | **Nutrição**: entrega o "o quê" que faltou + reabre a aula. Sobe consciência ANTES de vender |
| Passou do timestamp da oferta | `viu-oferta` | **alto** | **A sequência de fechamento abaixo (Msg 5→9)** - oferta direta, quebra de objeção, escassez |
| Ficou até o fim | `chegou-fim` | **máximo** | O lead mais quente sem ter comprado → **contato humano direto + prioridade máxima** |
| Comprou | `comprou` | cliente | **Sai de TODAS as sequências de venda** → onboarding |
...
> **EXEMPLO da máquina operando à vista (a escola de gestão, 8 dígitos):** o apresentador fala casual *"a gente vai mandar o PDF da aula automaticamente pro email de vocês... só pra quem ficou até o final"* e completa *"está no sistema, a gente consegue ver quem ficou até o final"*. Aquilo é a tag de 100% assistido operando na frente de todo mundo. (origem: cap09.)
...
|---|---|---|---|
| 0 | +1 dia (só espera) | Wait | Dá chance de comparecer à sessão que a pessoa marcou |
| 1 | D+1 | **Reciprocidade** | Manda o **melhor material grátis** (escasso - deletado das redes), anexado direto pra ficar íntimo |
...
>
> **Limpeza de lista (entregabilidade é bem comum frágil):** *"se a pessoa ficar um mês sem abrir nosso email, ela é excluída da lista, a gente dá unsubscribe automaticamente."* Higienizar não é perder lead - é proteger a entrega de TODOS os emails.

> **Como as duas camadas se encaixam:** Msg 5→9 (timing) = fechamento quente das primeiras 72h, ancorado no calor de quem acabou de ver a oferta. A esteira semanal acima = recuperação de médio prazo, sincronizada por semana. No perpétuo elas convivem: o lead entra na régua de 72h pela tag dele; quem não fecha cai na cadência semanal até comprar ou sair. **Nome da esteira completa: dê o nome do seu próprio sistema (o equivalente da automação "AutoAll" no seu nicho).**

---

### Mensagem 5 - 1h depois do webinar

**Função:** recapitula as 3 ideias-chave, confirma que a oferta segue aberta e que o bônus de ação rápida ainda vale por mais X horas. Pega o impulso quente de quem acabou de sair. **Vai pra `viu-oferta` e `chegou-fim`.** Quem tem `assistiu-50` recebe no lugar a versão nutrição (reconvite + entrega do "o quê" que faltou).

**EMAIL 4 - molde**

```
Assunto: Resumo do que vimos + bônus ainda válido

[Primeiro nome],

Acabamos.

Pra quem assistiu, valeu. Pra quem perdeu, vou pôr um trecho 
de 15 min no email seguinte.
...
```
Assunto: Como [Nome do Cliente] aplicou e o que aconteceu

[Primeiro nome],

Deixa eu te mostrar um caso real.

[Nome do cliente real] entrou em [Nome do Produto] em [mês/ano]. 
Estava em [situação inicial].

Em [tempo curto], aplicou [bloco do método]. Resultado: [número concreto].
...
→ FAQ com perguntas que outros como você mandaram: [URL]
→ Checkout direto: [URL]
...
[Primeiro nome do cliente] aplicou e fez [resultado curto] em [tempo].
...
Se você ainda quer entrar, faz agora:
...
```
Assunto: Encerrando essa janela
...
Se decidir ficar de fora, sem problema. 
Vou continuar postando conteúdo aqui - talvez na próxima.
...
```
Hoje à meia-noite fecho [Nome do Produto].
...
> **Só pra quem NÃO comprou.** Ou oferece um downsell (versão menor, mais leve), ou re-engaja com uma pergunta única. A opção B é a **melhor pesquisa de mercado que existe**: quem não comprou e responde te diz exatamente o que ajustar.

**Função (A - downsell):** redireciona pra um degrau mais barato da esteira. Quem não couber no ticket principal não está perdido - está com a objeção de preço pro produto errado.

**EMAIL 9** (opção A - downsell) - molde

```
Assunto: Versão menor pra quem ainda quer entrar

[Primeiro nome],

[Nome do Produto] fechou.

Pra quem não entrou agora mas quer começar a aplicar 
algumas peças, lancei uma versão reduzida:

[Nome do Downsell] - [preço menor]:
- [O que tem no downsell]
- [O que NÃO tem (que tinha no produto principal)]

Pra quem só quer testar o método em escala menor antes 
de entrar na próxima turma do principal.
...
**EMAIL 9** (opção B - re-engajamento sem downsell) - molde

```
Assunto: Por que não entrou? (resposta opcional, 1 linha)

[Primeiro nome],

Te mando esse email com uma pergunta só.

Por que não entrou em [Nome do Produto] essa semana?
...
Eu leio tudo. Algumas dessas viram ajuste no produto, 
outras viram conteúdo público.

Toca aí responder. Vai me ajudar e talvez te ajude 
a clarear teu próprio motivo.
...
### Para webinar de **alto ticket** (R$5k-25k+)

- Adiciona Email 6.5 (entre 24h e 48h): convite pra **call de qualificação** antes do checkout
- WhatsApp pode incluir áudio (mais íntimo)
- Sequência pós pode ir até 14 dias com nutrição extra

### Para webinar de **ticket médio** (R$1.5k-5k)

- Sequência padrão acima (9 emails + 9 WhatsApps)

### Para webinar de **ticket baixo** (R$300-1.5k)

- Reduz pra 5 emails + 5 WhatsApps
- Janela de fechamento mais curta (48-72h em vez de 5-7 dias)
- Pula o Email 6 (quebra de objeção dedicado) - incorpora no Email 5
...
### Email
- **Assunto**: 4-7 palavras, sem CAIXA ALTA, sem emoji excessivo
- **Pré-header** (texto que aparece após assunto): complementa, não repete
- **Abertura**: nome + 1 frase de contexto
- **Estrutura**: 1 ideia central + insight + CTA
- **Comprimento**: 200-400 palavras (mais que isso, ninguém lê)
- **CTA**: link claro + repetir 2x no email

### WhatsApp
- **Comprimento**: 50-150 palavras (até 5 linhas curtas)
- **Sem áudio longo** a não ser que cliente esperar (e se passar de 90 segundos, transcreve)
- **Sem encaminhamento de email**: reescreve no formato do canal
- **Emoji**: 1-2 no máximo, contextual
- **Link**: sempre encurtado e rastreável
- **Resposta direta**: cliente que responder, é tratado como lead quente - abre conversa 1-a-1

### Tom Soft mantido
- Sem motivacional vazio ("você consegue", "vai dar tudo certo")
- Sem urgência falsa ("só hoje" se não for)
- Sem caps lock excessivo
- Sem "AMIGO" ou "MEU CONSAGRADO"
- Sem GIF
- Direto. Curto. Útil.
...
### Email
**Plataformas:** Mailchimp, ActiveCampaign, ConvertKit, RD Station, Brevo (ex Sendinblue), MailerLite

**Setup mínimo:**
- DKIM, SPF, DMARC configurados (entregabilidade)
- Lista segmentada por estágio (cadastrado / atendente / não-comprador / comprador)
- Automation rule: trigger por evento (cadastrou no webinar) → dispara sequência
...
- Atendimento direto no WhatsApp pessoal/business
- Mensagens copy-paste

**Opção 2 - Automatizado (100+/semana):**
- Plataformas: ManyChat, Take Blip, Botmaker, Zenvia, Twilio
- Templates aprovados pela Meta (regra de WhatsApp Business API)
- Disparos via webhook do gateway de cadastro
...
| Métrica | Faixa esperada | Soft alvo |
|---------|----------------|-----------|
| Taxa abertura email pré | 35-50% | 45%+ |
| Taxa clique email pré | 8-15% | 12%+ |
| Taxa atendimento webinar | 30-50% | 45%+ |
| Taxa abertura email pós | 25-40% | 35%+ |
| Compra automática no checkout (de quem comparece) | 6-8% | antes de qualquer comercial tocar |
| Taxa conversão pós-webinar (lead → compra) | 3-12% | 5%+ no perpétuo, 10%+ no ao vivo |
| Resposta ao Email 9 (re-engajamento) | 5-15% | 10%+ (insumo de pesquisa) |

> Mês 1: executa cego nessas faixas. Mês 3+: substitui pelos próprios dados.
...
- [ ] Todos os 9 emails escritos com assunto, pré-header, corpo e CTA
- [ ] Todos os 9 WhatsApps escritos
- [ ] Variáveis dinâmicas configuradas ([primeiro nome], [link checkout], etc.)
- [ ] Plataforma de email com DKIM/SPF configurados
- [ ] WhatsApp Business com templates aprovados (se automatizado)
- [ ] Trigger de envio configurado (evento "cadastro" dispara sequência)
- [ ] **Timestamp da oferta definido** (o segundo exato em que a oferta abre na aula)
- [ ] **Marcos de % assistido configurados** na plataforma (0-25 / 25-75 / passou-da-oferta / 100%)
- [ ] **Tags criadas:** `nao-compareceu`, `assistiu-0`, `assistiu-50`, `viu-oferta`, `chegou-fim`, `comprou`, e as de objeção (`objecao-preco`, `objecao-tempo`, `quer-high`)
- [ ] **Roteamento por tag ligado:** quem `viu-oferta` recebe fechamento; quem saiu antes recebe nutrição; quem `nao-compareceu` recebe só reconvite; quem `comprou` sai de TUDO
- [ ] Filtro "é cliente?" na entrada da esteira (não vender aquisição pra quem já comprou)
- [ ] Segmentação: lista separada pra cadastrados que não compraram
- [ ] Links rastreados (UTM em todos)
- [ ] Test envio feito pra você mesmo antes de subir

---

## Notas operacionais

- **Pós-webinar com volume**: a partir de 50+ cadastros por sessão, automatize WhatsApp. Manual só funciona em volume baixo.
- **Pós-webinar com baixo volume (validação)**: faça MANUAL no início. Sente o que cliente responde, ajusta as mensagens, depois automatiza.
- **Email 9 (re-engajamento)**: a melhor pesquisa de mercado. Quem não comprou e responde é insumo direto pra ajustar o produto/oferta/copy.
- **Sequência ao vivo vs perpétua**: estrutura é a mesma, **timing** muda. No ao vivo, datas absolutas. No perpétuo, datas relativas ao cadastro de cada lead.
