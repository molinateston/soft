...
2. **Dá pra provar ou desmentir?** Frase que não é verdadeira-ou-falsa é enchimento. "Somos referência" não se prova; "300 pacientes atendidos em dois anos" (exemplo ilustrativo, nicho nutricionista) se prova. Não diga o adjetivo, aponte o fato.
3. **Só você poderia dizer isso?** Se o concorrente assina a mesma frase, ela não diferencia. "Ajudo você a crescer" qualquer um assina; "monto com você o mesmo protocolo que me tirou da agenda lotada sem perder paciente" (exemplo ilustrativo) só você.
...
**Anti-voz do autor do método** (cresce a cada correção): ele NÃO usa **"travar / travado / trava"** (era "travar a posição"). Prefere ocupar, cravar, fincar, deixar de pé, feito. Pra cliente bloqueado: empacado, emperrado. Lista viva, atualizada a cada correção.
