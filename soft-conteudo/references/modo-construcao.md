...
4. **Anti-IA** (`shared-references/filtro-anti-ia/padroes-banidos.md` + `teste-voz-alta.md`): roda os 12 padrões banidos e lê em voz alta antes de imprimir a tabela. Em-dash, tricolon, contraste "não é X, é Y" repetido, abertura dramática isolada ("O mais cruel") é FALHA, reescreve. O Crivo dá a força, o anti-IA tira o robô. Os dois antes de entregar.
