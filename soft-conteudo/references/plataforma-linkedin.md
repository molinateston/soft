...
1. **Primeiros 150 caracteres = tudo.** É o que aparece antes do "ver mais". Determina se expande.
2. **Zero link externo no corpo.** Penalização de 60% de reach. Link sticker no comentário tb é penalizado. CTA é sempre DM do LinkedIn ou "comenta X".
3. **Document post (PDF carrossel) domina.** 1080x1350px (portrait), 5-10 slides, 6-7% engagement médio. 2-3x mais dwell que texto puro.
4. **Texto puro só funciona longo e estruturado.** 800-1300 caracteres, parágrafos de 2-3 linhas, white space generoso, bullet/numeração quando faz sentido.
5. **Vídeo nativo vertical <90s** com captions (muitos assistem no mudo).
6. **Saves > likes no algoritmo 2026.** Estrutura a peça pra ser **salva** (framework, checklist, passo a passo).
7. **Comentários pesam 15x mais que likes.** CTA sempre pede resposta em comentário, nunca reação.
...
[Método nomeado + como funciona em 2-3 parágrafos curtos.]
...
- [ ] Primeiros 150 caracteres polarizam e geram click no "ver mais"?
