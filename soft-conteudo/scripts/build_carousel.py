...
def build_embedded_fonts(font_combo):
    ...
    Se um arquivo de fonte estiver faltando, ele é silenciosamente pulado
    (cai no fallback do sistema). Isso é por design — a skill prefere degradar
    graciosamente do que crashar.
    """
