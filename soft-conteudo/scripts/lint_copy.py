...
HARD = [
    (re.compile(r'[—–]'),
     'EM-DASH (banido zero-tolerância; troque por ponto ou hífen comum)'),
    (re.compile(
     ...
     'família "travar" (anti-voz Soft; use emperrar/empacar/parar/freio/amarra) '
     '— exceção só em citação literal do cliente entre aspas'),
]
