...
description: "Editor de vídeo do método Soft: transforma um talking-head cru (9:16) num reels com b-roll gerado por IA (imagem no gpt-image-2, animação no Veo 3.1 fast) na faixa de baixo e o apresentador inteiro em cima, mais corte de roteiro/silêncio, gancho (cold open), legenda, CTA fixo no final e música de fundo discreta. Marca-neutra: na PRIMEIRA vez roda o ONBOARDING (pede as chaves de API do dono e entrevista os personagens dele em config/). Use quando o dono mandar um vídeo JÁ GRAVADO pra editar, pedir b-roll, gerar reels a partir de uma gravação, enxugar/cortar, ou criar gancho/cold open. Esta skill EDITA o vídeo gravado; escrever o roteiro (o que falar/mostrar) antes de gravar é soft-conteudo-reels."
---
