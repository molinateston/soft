...
description: "Fecha o PACOTE do MINI WEBINAR Soft (degrau 1, Funil Soft): o vídeo de ~10min que filtra, instala UMA virada de percepção e move pro 1:1, MAIS os SLIDES (1 ideia por slide, copy na nota) e a PÁGINA DE HOSPEDAGEM RICA (player + provas + bio + FAQ + argumento estilo carta abaixo dele). É a Carta com câmera, arco ADMA comprimido, mecanismo nomeado no centro. Entrega UMA peça por vez com STOP, gate por dentro (ADMA-micro + anti-IA). Use pra \"mini webinar\", \"webinar curto\", \"versão em vídeo da carta\", \"página de hospedagem do vídeo\". Esta skill é o degrau 1 (vídeo curto de filtro); o degrau 2, o WEBINÁRIO COMPLETO/perpétuo, é soft-webinario."
---
