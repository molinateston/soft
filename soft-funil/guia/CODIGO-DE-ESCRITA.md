...
2. **Dá pra provar ou desmentir?** Frase que não é verdadeira-ou-falsa é enchimento. "Somos referência" não se prova; "atendi 800 pacientes em dez anos" (exemplo ilustrativo) se prova. Não diga o adjetivo, aponte o fato.
3. **Só você poderia dizer isso?** Se o concorrente assina a mesma frase, ela não diferencia. "Ajudo você a crescer" qualquer um assina; "monto com você o consultório que montei pra mim, em metade do tempo" (exemplo ilustrativo) só você.
...
**Anti-voz do autor do método** (cresce a cada refinamento): NÃO se usa **"travar / travado / trava"** (era "travar a posição"). Prefira ocupar, cravar, fincar, deixar de pé, feito. Pra cliente bloqueado: empacado, emperrado.
