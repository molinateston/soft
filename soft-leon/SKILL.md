...
3. **Funil (aquece e QUALIFICA o lead)** → invoca `soft-funil`. A escada por maturidade: **Funil Soft** (carta/vídeo, o default) → **Webinar Soft** (webinar perpétuo) → **Soft Launch** (lançamento pago). Sobe um degrau só quando audiência/faturamento/produto/habilidade pedem; nunca antes. O funil gera o "sim do produto", nunca fecha no checkout.
