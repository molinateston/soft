...
description: "Constrói o Plano de Posicionamento Incomum COMPLETO, a FUNDAÇÃO do método Soft (Posicionamento, o quê, junto da Voz, o como). Entrega o Racional, o Grande Dominó (a tese-mãe que vende), o Mecanismo do Problema, o Mecanismo da Solução nomeado, a Oferta com PUV, 2 saídas (Perfil Enxuto, Fundação de Headlines) e os 5 elementos de Voz. Vira o cérebro do LEON do cliente. Combina deep-research com entrevista estratégica. Use quando o pedido for posicionamento, plano de marca, reposicionamento, proposta de valor, PUV, cliente ideal, tom de voz. Esta skill constrói a FUNDAÇÃO estratégica (o que vender e com que voz); escrever a peça em si usa as skills soft-conteudo/soft-funil correspondentes."
---
...
Na primeira invocação da sessão, **leia primeiro o guia**: o framework, o mecanismo-matriz (Reorganização da Percepção / ADMA) e a régua de coerência saem daqui - sobretudo `guia/CODIGO-DE-ESCRITA.md` e `guia/02-plano-marca-pessoal.md` (já genéricos). O Plano do USUÁRIO é construído com o eixo DELE. Depois:
...
- **Anti-raso do Mecanismo (inegociável).** O Mecanismo da Solução é **nomeado e concreto**, um fenômeno do domínio que explica por que funciona. Cada parte da explicação (pilar, premissa, característica OU passo) só fecha com mecanismo concreto. Teste: se a premissa cabe em qualquer especialista do nicho, está rasa, desce até o fenômeno técnico real. Sai da pesquisa + entrevista.
- **Forma:** pegada falada (*eu diria isso no olho de um cara experiente?*) · **simples e honesto, nunca fácil e mágico** (o avatar já tentou a fórmula mágica e tomou pau) · **sem travessão na copy**. O corpo do plano é técnico e mostra o racional; bio, headlines e frases de voz são curtas e faladas.
...
3. **Entrevista dirigida** (6 perguntas num bloco só): o Problema Avançado que achei bate? · transformação concreta (número+prazo) · 3 conselhos de mercado que você quer quebrar · o que você faz que nenhum concorrente faz · cases reais (nome+número) · ticket de hoje e meta de 90 dias.
...
| **Anti-IA (HARD)** | zero travessão "—" · zero "travar/travado/destravar" (exceção: aspa literal do usuário) · sem frase-emoldura nem verbo-clichê; no Code roda `python3 scripts/lint_copy.py`, no chat faz CTRL+F manual de "—" e da família "travar" | `filtro-anti-ia/` | |
| **Regulado (se SAÚDE/JURÍDICO)** | promessa, número, garantia e linguagem passam no gate regulado; N/A se o nicho não é regulado | `crivo/04-gate-regulado.md` | |
...
**Posicionamento:** `references/bloco-2-metodo.md` (engenharia de nomeação do método: técnicas de nome, lista negra, proibições) · `references/bloco-3-oferta.md` (engenharia de execução da Oferta: equação trabalhada, entregável-tese, mapa, níveis, ancoragem, o racional "por que é assim / por que deixa de ser") · `references/circulo-tematico.md` (planejamento temático) · `references/modo-perfil.md` (bio/perfil: templates, diagnóstico) · `references/bloco-5-fundacao-headlines.md` · `references/prompts-mente-cliente.md` (protocolo de avatar profundo: 9 movimentos que aprofundam o Bloco 1 - hipótese da IA que volta pra entrevista confirmar) · `references/conducao-na-pratica.md` (o jeito de conduzir destilado de sessões reais - ângulo, problema avançado, mecanismo desejável, oferta por valor; exemplos de nichos neutros, nunca o Léo).
