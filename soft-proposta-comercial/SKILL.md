...
description: "Transforma uma call de venda gravada numa PROPOSTA COMERCIAL premium: um site HTML estático single-file (abas, diagnóstico, entregáveis com checkbox persistente, cronograma/Gantt, investimento, prova social, CTA), publicado num link único e privado por cliente. Pipeline em 4 etapas (transcrição, extração, geração do HTML no Layout Soft, publicação). Marca-neutra: cor, fontes, logo e prova social vêm do DONO. Use quando o dono precisar ENTREGAR a proposta em formato premium, pedir 'monta a proposta', 'proposta comercial', ou quiser fugir do PDF travado. Esta skill gera a proposta que antecede a venda; o contrato que formaliza depois é soft-contratos-consultoria."
---
