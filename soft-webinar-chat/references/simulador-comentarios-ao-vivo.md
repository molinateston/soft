...
> - **Como GRAVAR com energia** (3 formas de gravar, conduta de sala, eco de chat real, setup): roteiro/gravação = território da **soft-webinar-gravacao**. Aqui é o que entra no chat DEPOIS de a gravação existir.
