...
description: "Escreve a SEQUÊNCIA de WhatsApp (canal primário, API oficial) e e-mail (secundário) do webinar Soft que enche a sala e fecha a venda, SEM replay. Cobre a régua de ANTES (cadastro com opt-in, faltam 24h/1h, link da sala 5 min antes), os 2 toques DURANTE (reativa quem se distraiu, avisa que a oferta abriu) e o PÓS pra quem NÃO comprou (resumo, prova, quebra de objeção, last call, downsell) roteado pela tag de percentual assistido. Use quando o pedido for WhatsApp, e-mails, lembrete ou follow-up do webinar, faltam 30 minutos, link da sala, reconvite, pós-webinar. Esta skill escreve as MENSAGENS de convite e cobrança; as PÁGINAS de cadastro e checkout são soft-funil-landing/soft-webinar-paginas."
---
