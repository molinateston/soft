...
- Botão largo na cor de ação: **"Garantir minha vaga →"** → leva pra `/ficha/`
...
- **Tela final:** *"Pronto, [nome]. Vaga garantida."* + **único próximo passo = botão WhatsApp** com mensagem pré-pronta: *"Oi o autor do corpus! Acabei de preencher minha ficha da masterclass. Quero garantir minha vaga na sala."* + nota: *"A sala abre no horário que você escolheu · não falta, tem presente no fim."*
