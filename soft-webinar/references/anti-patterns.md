# Anti-Patterns das páginas do webinar (sintoma → correção)

Abra sempre que uma página falhar no gate linha a linha (P7): acha o sintoma na coluna da esquerda e aplica a correção.
