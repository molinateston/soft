# Os blocos das 3 páginas, bloco a bloco (a profundidade que os Passos 1, 1.B, 2 e 3 mandam ler)

## Índice
- Passo 1, os 9 blocos da página de CADASTRO
- Passo 1.B, a BIO DETALHADA na ÚLTIMA DOBRA
- Passo 2, a página de OBRIGADO / Lembrete (web-v1) + a FICHA + a variante AO VIVO
- Passo 3, a página de CHECKOUT ENXUTO (5 blocos + o corte explícito)
...
## Passo 1.B, a BIO DETALHADA na ÚLTIMA DOBRA (regra das páginas, do bench do corpus estudado)
**Onde:** penúltima/última dobra, DEPOIS do conteúdo da aula/oferta, ANTES do fecho. NUNCA no topo. **Em quais:** CADASTRO e OBRIGADO. **CHECKOUT não leva** (já viu o cara na aula; bio lá é fricção). **Função:** valida autoridade SEM currículo. **Ordem fixa:** empatia/cicatriz ANTES do feito (cicatriz antes do troféu). **Lê `references/_PAGINAS-BENCH.md` Seção 1 pros 2 textos verbatim do corpus estudado.**
...
**O molde da prosa (5 parágrafos, a ordem que o autor do corpus bate):**
...
| ❌ Fora | Por quê |
|---|---|
| FAQ longo (5-7 perguntas) | é o checkout "completo" da reference; o autor do corpus pediu enxuto |
