...
**Efeito:** a partir daqui o comprador deixa de achar que compra um curso de R$1.997 e passa a achar que GANHA R$9.100. O bonus maior que o produto vira o motivo da compra. **Esta e a jogada que o autor do corpus ainda NAO copiou e esta disponivel** (ver Parte III).
...
- **Nao decalcar rotulo com dono.** "Bonus do combinado nao sai caro" / "GPS da Gestao Agil" = 13M; "Black Belt Club" = Bruno. No Soft: mesma premissa, nome do corpus estudado, validado com ele.
