...
> **A ordem dos 72 beats segue o SLIDE-MODELO.** A espinha canônica, bloco a bloco e com os templates de fala, é o `SLIDE-MODELO-SCRIPT.md` (nesta pasta). Estes 72 beats são esse slide-modelo expandido em granularidade de TELA. Quando um beat aqui divergir do slide-modelo, **o slide-modelo ganha**.
>
...
- [ ] O bloco de oferta+fechamento mantém peso pleno, não encurtar (G6); a distribuição das fases segue a consciência do público cravada na entrevista.
